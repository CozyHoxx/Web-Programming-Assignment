            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <?php 
                            if(!empty($_SESSION) && $_SESSION['usertype']=="Organizer"){
                                echo '<a href="profile_org.php" class="nav-link active">Profile<span class="sr-only">(current)</span></a>';
                            } else if (!empty($_SESSION) && $_SESSION['usertype']=="User"){
                                echo '<a href="profile.php" class="nav-link active">Profile<span class="sr-only">(current)</span></a>';
                            }
                        ?>
                    </li>
            ...
            <div class="col-lg-4 col-md-5 col-sm-12">
                <div class="nav flex-column nav-pills mt-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab"
                        aria-controls="v-pills-home" aria-selected="true">About me</a>
                    <a class="nav-link" id="v-pills-event-tab" data-toggle="pill" href="#v-pills-event" role="tab"
                        aria-controls="v-pills-event" aria-selected="false">Events Hosted</a>
                    <!-- <a class="nav-link" id="v-pills-notification-tab" data-toggle="pill" href="#v-pills-notification"
                        role="tab" aria-controls="v-pills-notification" aria-selected="false">Send Notification</a> -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-user-information">
                                        <tr>
                                            ...
                                            <td>
                                                <p><?php echo $_SESSION['organizer_name']; ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                ...
                ?>
                    ...
                    <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                        ...
                        <div class="form-style-10">
                            <h1>Profile Editing<span>Please note that your information will be changed directly in the
                                    database</span></h1>
                            <form action="profile_edit.php" method="post">
                                <div class="section"><span>1</span>Your Name</div>
                                <div class="inner-wrap">
                                    <label>Organizer Name <input type="text" name="organizer_name"
                                            value="<?php echo $_SESSION['organizer_name']; ?>" required></label>
                                </div>
                                ...
                                <div class="button-section">
                                    <input type="submit" name="submit_org" />
                                </div>
                            </form>
                            <br>
                            <form action='delete_account.php' method="POST">
                                <input type="submit" action style="background-color: #b22222" name="delete_org"
                                    value="Delete"
